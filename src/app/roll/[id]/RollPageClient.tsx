  ...
  return (
    <main className="max-w-2xl mx-auto px-4 py-16">
      ...
      <div className="bg-blue-900 rounded-xl p-8 shadow-xl border border-blue-800">
        ...
        {/* Expiration notice */}
        <div className="mt-4 p-3 bg-blue-950/50 border border-blue-800 rounded-lg text-xs text-blue-300 text-center">
          ⏱️ This roll will expire in <strong className="text-blue-200">{timeUntil(roll.expiresAt)}</strong>
          {roll.isRevealed
            ? " (revealed rolls are kept for 1 week)"
            : " (unrevealed rolls are kept for 2 weeks)"}
        </div>
      </div>
    </main>
  );
